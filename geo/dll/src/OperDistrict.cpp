...
struct DistrictOperator : public UnaryOperator
{
	...
	bool CreateResult(TreeItemDualRef& resultHolder, const ArgSeqType& args, bool mustCalc) const override
	{
		...
		auto resUnit_owner = ResultUnitType::GetStaticClass()->CreateResultUnit(resultHolder.GetNew()); auto resUnit = resUnit_owner.get();
		...
		if (mustCalc)
		{
			...
			auto resLockUnique = CreateHeapTileArrayV<district_type>(inputGrid->GetTiledRangeData().get(), nullptr, false MG_DEBUG_ALLOCATOR_SRC("OperDistrict: resLock"));
