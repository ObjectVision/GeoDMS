...
// 31-7-2024: Note by MH, Object Vision: temporarily ported here awaiting CGAL 6.0 release through vcpkg
// All code adapatation are marked with <MTA>, </MTA>, or <MTA/>

#ifndef CGAL_POLYGON_REPAIR_H
#define CGAL_POLYGON_REPAIR_H

// GeoDMS is only licensed as GNU GPL 3.0 
...
namespace CGAL {
    ...
    using Multipolygon_with_holes_2 = std::list<CGAL::Polygon_with_holes_2<Kernel, Container> >;
} // namespace CGAL
...
//<MTA>      mp.add_polygon_with_holes(std::move(polygon));
        mp.emplace_back(std::move(polygon)); // </MTA>
    }
  }
