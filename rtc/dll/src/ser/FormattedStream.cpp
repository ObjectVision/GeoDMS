...
#endif
DEFINE_FORMATTED_STREAMABLE(Float32, double, 20, "%9G", ENABLE_UNDEF_HANDLING)
DEFINE_FORMATTED_STREAMABLE(Float64, double, 35, "%.17G", ENABLE_UNDEF_HANDLING)
#if defined(DMS_TM_HAS_FLOAT80)
DEFINE_FORMATTED_STREAMABLE(Float80, long double, 40, "%.17lG", ENABLE_UNDEF_HANDLING)
#endif
