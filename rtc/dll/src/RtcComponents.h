...
//
// The ctors/dtors are RTC_CALL-exported so objects in other modules (tic, sym,
// ...) can derive from them too, both while those modules are separate DLLs
// (dllimport) and after they are merged into one (intra-DLL).
//----------------------------------------------------------------------
