...
auto CreateFileTileArray(const AbstrDataItem* adi, const SharedObj* abstrValuesRangeData, dms_rw_mode rwMode, SharedStr filenameBase, bool isTmp)->std::unique_ptr<AbstrDataObject>;
