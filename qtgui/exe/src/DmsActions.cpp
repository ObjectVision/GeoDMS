...
void createDmsActions() {
    ...
    main_window->m_histogramview_action->setIcon(main_window->getIconFromViewstyle(ViewStyle::tvsHistogram, ChartKind::Histogram));
    ...
    main_window->m_scatterview_action->setIcon(main_window->getIconFromViewstyle(ViewStyle::tvsHistogram, ChartKind::Scatter));
    ...
    main_window->m_lineview_action->setIcon(main_window->getIconFromViewstyle(ViewStyle::tvsHistogram, ChartKind::Line));
    ...
    main_window->m_barview_action->setIcon(main_window->getIconFromViewstyle(ViewStyle::tvsHistogram, ChartKind::Bar));
