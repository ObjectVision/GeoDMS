...
public slots:
    ...
    void splashScreen();
    void wiki();
    void createView(ViewStyle viewStyle, ChartKind chartKind = ChartKind::Histogram);
...
public: 
    ...
    std::unique_ptr<QAction> m_reopen_action, m_export_primary_data_action
        ...
        , m_histogramview_action, m_scatterview_action, m_lineview_action, m_barview_action, m_pieview_action
