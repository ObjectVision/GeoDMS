...
enum class EventID : EventIdType  {
	...
	REQUEST_INFO  = 0x08000,
	REQUEST_SEL   = 0x10000,

	CLOSE_EVENTS  = LBUTTONUP|CAPTURECHANGED|MOUSEMOVE|SCROLLED, // end controller gestures

	HANDLED       = 0x00020000,
	SETCURSOR     = 0x00040000,
	COPYCOORD     = 0x00080000,
