...
{
	AbstrUnit* auTableGroups = Unit<UInt32>::GetStaticClass()->CreateUnit(container, GetTokenID_mt("gdal_grid")).get(); // item owned by parent; raw stays valid
	AbstrDataItem* adiShortName = CreateDataItem(auTableGroups, GetTokenID_mt("ShortName"), auTableGroups, Unit<SharedStr>::GetStaticClass()->CreateDefault()).get(); // owned by auTableGroups (parent)
	AbstrDataItem* adiLongName = CreateDataItem(auTableGroups, GetTokenID_mt("LongName"), auTableGroups, Unit<SharedStr>::GetStaticClass()->CreateDefault()).get();
	AbstrDataItem* adiHelpUrl = CreateDataItem(auTableGroups, GetTokenID_mt("HelpUrl"), auTableGroups, Unit<SharedStr>::GetStaticClass()->CreateDefault()).get();
	AbstrDataItem* adiOptions = CreateDataItem(auTableGroups, GetTokenID_mt("CreationOptionList"), auTableGroups, Unit<SharedStr>::GetStaticClass()->CreateDefault()).get();
...
{
	AbstrUnit* auTableGroups = Unit<UInt32>::GetStaticClass()->CreateUnit(container, GetTokenID_mt("gdal_vect")).get(); // item owned by parent; raw stays valid
	AbstrDataItem* adiShortName = CreateDataItem(auTableGroups, GetTokenID_mt("Name"), auTableGroups, Unit<SharedStr>::GetStaticClass()->CreateDefault()).get(); // owned by auTableGroups (parent)
	AbstrDataItem* adiCanCreate = CreateDataItem(auTableGroups, GetTokenID_mt("CanCreate"), auTableGroups, Unit<Bool     >::GetStaticClass()->CreateDefault()).get();
	AbstrDataItem* adiCanDelete = CreateDataItem(auTableGroups, GetTokenID_mt("CanDelete"), auTableGroups, Unit<Bool     >::GetStaticClass()->CreateDefault()).get();
...
GDALDatasetHandle Gdal_DoOpenStorage(const StorageMetaInfo& smi, dms_rw_mode rwMode, UInt32 gdalOpenFlags, bool continueWrite)
{
	...
	if (!continueWrite || std::string_view(driver_short_name) == "GML" || (gdalOpenFlags & GDAL_OF_RASTER))
	{
		...
		gdal_error_frame.GetMsgAndReleaseError(); // start empty, release error in case of nonexistence.
