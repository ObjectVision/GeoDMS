...
// String operators (concat, substr/left/right, repeat, strpos/strrpos/strcount,
// string formatting), the first-class pow operators, and the unit-level
// mul/div/pow operators with their mixed-type instantiation table.
// The binary functor machinery and the heavy per-value-type instantiations were
// split into OperAttrBinImpl.h + OperAttrBin_{muldiv,addsub,compare,bits}.cpp
// (2026-08) for parallel compilation.
